...
public class SubcontractorServiceTest {
	...
	public void testGetAllSubcontractorWithData() {
		...
		List<SubcontractorDto> result = subcontractorService.getAllSubcontractors(nameColonne, sorting, page, pageSize);
	...
	public void testGetAllSubcontractorWithNoData() {
		...
		assertThrows(RuntimeException.class, () -> {
			subcontractorService.getAllSubcontractors(nameColonne, sorting, page, pageSize);
		});
	}
