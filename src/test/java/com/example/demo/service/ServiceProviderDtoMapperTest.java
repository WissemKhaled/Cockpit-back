...
//		assertEquals(serviceProviderEntity.getSpStatus().getStId(), serviceProviderDto.getSpStatusId());
...
//		serviceProviderDto.setSpStatusId(1);
...
//		assertEquals(serviceProviderDto.getSpStatusId(), serviceProvider.getSpStatus().getStId());
