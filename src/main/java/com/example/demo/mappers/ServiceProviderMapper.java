...
public interface ServiceProviderMapper {
	...
	@Select("SELECT sp.sp_id, sp.sp_first_name, sp.sp_name, sp.sp_email, sp.sp_creation_date, sp.sp_lastUpdate_date, sp.sp_fk_subcontractor_id, sp.sp_fk_status_id "
			+ "FROM gst_service_provider sp " + "WHERE sp.sp_id = #{spId}")
	@Result(property = "spId", column = "sp_id")
	...
	@Select("SELECT sp.sp_id, sp.sp_first_name, sp.sp_name, sp.sp_email, sp.sp_creation_date, sp.sp_lastUpdate_date, st.st_id as status_stId, st.st_name as status_stName, "
			...
			+ "FROM gst_service_provider sp " + "INNER JOIN gst_subcontractor s ON sp.sp_fk_subcontractor_id = s.s_id "
			+ "INNER JOIN gst_status st ON sp.sp_fk_status_id = st.st_id " + "WHERE sp.sp_id = #{spId}")
	@Result(property = "spId", column = "sp_id")
	@Result(property = "spFirstName", column = "sp_first_name")
	@Result(property = "spName", column = "sp_name")
	@Result(property = "spEmail", column = "sp_email")
	...
	@Select("SELECT sp.sp_id, sp.sp_email " + "FROM gst_service_provider sp " + "WHERE sp.sp_email = #{spEmail}")
	@Result(property = "spId", column = "sp_id")
	@Result(property = "spEmail", column = "sp_email")
	...
	@Select("SELECT sp.sp_id, sp.sp_first_name, sp.sp_name, sp.sp_email, sp.sp_creation_date, sp.sp_lastUpdate_date, "
			+ "s.s_id as subcontractor_sId, s.s_name as subcontractor_sName " + "FROM gst_service_provider sp "
			+ "INNER JOIN gst_subcontractor s ON sp.sp_fk_subcontractor_id = s.s_id "
			+ "WHERE sp_fk_subcontractor_id = #{sId} " + "ORDER BY sp_id")
	@Result(property = "spId", column = "sp_id")
	@Result(property = "spFirstName", column = "sp_first_name")
	@Result(property = "spName", column = "sp_name")
	@Result(property = "spEmail", column = "sp_email")
	...
	@Select("SELECT sp.sp_id, sp.sp_first_name, sp.sp_name, sp.sp_email, sp.sp_creation_date, sp.sp_lastUpdate_date, "
			...
			+ "s.s_id as subcontractor_sId, s.s_name as subcontractor_sName " + "FROM gst_service_provider sp "
			+ "INNER JOIN gst_subcontractor s ON sp.sp_fk_subcontractor_id = s.s_id "
			+ "INNER JOIN gst_status st ON sp.sp_fk_status_id = st.st_id " + "WHERE st.st_id != 4 "
	...
	@Select("SELECT sp.sp_id, sp.sp_first_name, sp.sp_name, sp.sp_email, sp.sp_creation_date, sp.sp_lastUpdate_date, "
			...
			+ "s.s_id as subcontractor_sId, s.s_name as subcontractor_sName " + "FROM gst_service_provider sp "
			+ "INNER JOIN gst_subcontractor s ON sp.sp_fk_subcontractor_id = s.s_id "
			+ "INNER JOIN gst_status st ON sp.sp_fk_status_id = st.st_id " + "WHERE st.st_id = ${statusId} "
	...
	@Result(property = "subcontractor.sId", column = "subcontractor_sId")
	@Result(property = "subcontractor.sName", column = "subcontractor_sName")
	List<ServiceProvider> findAllServiceProvidersByCriteriaAndFiltredByStatus(@Param("columnName") String columnName,
			@Param("searchTerms") String searchTerms, @Param("pageSize") int offset, @Param("offset") int pageSize,
	...
	@Result(property = "subcontractor.sId", column = "subcontractor_sId")
	@Result(property = "subcontractor.sName", column = "subcontractor_sName")
	List<ServiceProvider> findServiceProvidersByCriteria(@Param("columnName") String columnName,
			@Param("searchTerms") String searchTerms, @Param("pageSize") int offset, @Param("offset") int pageSize);
	...
	@Select("SELECT COUNT(*) " + "FROM gst_service_provider sp "
			+ "INNER JOIN gst_subcontractor s ON sp.sp_fk_subcontractor_id = s.s_id "
			+ "WHERE ${columnName} ILIKE #{searchTerms} || '%' " + "AND sp.sp_fk_status_id != 4 ")
	int findNumberOfAllServiceProvidersByCriteria(@Param("columnName") String columnName,
			@Param("searchTerms") String searchTerms);

	@Select("SELECT COUNT(*) " + "FROM gst_service_provider sp "
			+ "INNER JOIN gst_subcontractor s ON sp.sp_fk_subcontractor_id = s.s_id "
			+ "WHERE ${columnName} ILIKE #{searchTerms} || '%' " + "AND sp.sp_fk_status_id = ${statusId} ")
	int findNumberOfAllServiceProvidersByByCriteriaAndFiltredByStatus(@Param("columnName") String columnName,
			@Param("searchTerms") String searchTerms, @Param("statusId") int statusId);
