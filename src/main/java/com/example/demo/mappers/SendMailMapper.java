...
public interface SendMailMapper {
	...
	void saveMailAndSend(SendMailDTO message_send); 
	
	@Insert("INSERT INTO gst_message_send (ms_to, ms_cc, ms_subject, ms_body,  ms_status, ms_creation_date, ms_fk_model_email_id) "
	...
	void saveMailAndSend2(SendMailDTO message_send); 
}
