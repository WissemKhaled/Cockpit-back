	...
	*/
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		return http.csrf(csrf -> csrf.disable())
				.authorizeHttpRequests(ar -> ar.requestMatchers("/auth/addNewUser", "auth/user/userdetails", "/auth/generateToken", "/auth/refreshToken", "/subcontractor/**", "/MessageModel/**").permitAll())
