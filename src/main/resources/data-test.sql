...
CREATE TABLE IF NOT EXISTS subcontractor_test (
    s_id SERIAL PRIMARY KEY,
    s_name VARCHAR(250) NOT NULL,
    s_email VARCHAR(45) NOT NULL,
    s_fk_status_id SMALLINT NOT NULL, 
    FOREIGN KEY (s_fk_status_id) REFERENCES status_test(st_id)
);

INSERT INTO status_test (st_id, st_name, st_description)
...
INSERT INTO subcontractor_test (s_name, s_email, s_fk_status_id )
